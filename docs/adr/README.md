...
2026-09-15時点で23件となり、`CP-0096`のヘッダ項目の点検で不整合が6件見つかった（ADR-0001・0002・0006が3項目欠落、ADR-0003が3項目欠落と独自ラベル`後継ADR`、ADR-0004・0005が1項目欠落）。**再検討条件は件数と不整合の両方で満たされている。** 判断そのものは`CP-0086`が行う。
