...
- 同じカードを他店舗と照合できるか: `メガレックウザex`は同じセットに4候補あったが、`M6 + 110/076 + SAR`では1候補になった。現行買取価格25,000円はドラゴンスターの同一属性と一致し、晴れる屋2の33,000円とも属性上は比較できる。状態条件の等価性は確認できないため、掲載条件を保持して別観測として扱う
